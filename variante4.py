...
def solucion(A):
    ...
    for i in range(len(A)):
        for j in range(len(A)):
            ...
            if red*red == aux:
                ...
                cuadrados_perfectos.append(aux)
    """
    ...
    -n_cuadrados_perfectos: Número de cuadrados perfectos que aparece en la matriz A, 
        es de tipo float o entero (Elige el tipo que quieras).
    -cuadrados_perfectos: Lista de números cuadrados perfectos que hay en la matriz A, 
        es de tipo float o entero (Elige el tipo que quieras).
